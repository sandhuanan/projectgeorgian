...
if (isset($_POST['submit']))
{
    ...
    if($filename != '')
    {
        ...
        {
            header("Location: facultystaffpage.php?st=error");
        }
    }
    else {
           header("Location: facultystaffpage.php");
...
<div class="container">
    ...
    <div class="content">
			<h2 style="text-align: center; font-weight: bold;">Faculty Staff Researchers</h2>
    </div>
